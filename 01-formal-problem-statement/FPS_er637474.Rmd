...
It is also possible that an inferential test of the energy-reduction model will not produce a high probability that the methods used are reducing cost over an annual period, leading to suspect that failure of model deployment is imminent. 
