...
1. How many engine cycles are there (starting now) before the engine will fail? – the challenge here is that predicting engine lifetimes accurately can be very difficult
