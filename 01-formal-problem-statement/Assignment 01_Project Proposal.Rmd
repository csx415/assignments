...
The goal of this "Kickstarter Implementation Project Proposal" is to successfully identify new companies that Angel Investors Unlimited should create partnerships with. By implementing strategic prediction models to identify successful Kickstarter campaigns, our goal at 3D Solutions is to help Angel Investors Unlimited (AIU) choose which companies to invest in and create partnerships with that will ultimately increase their return on investment by 20% annually.  
...
The Kickstarter Implementation Project Plan will be broken into four phases: Pre-Model Creation, Model Creation, Training Model, and Implementing Model. 
  ...
  2. Model Creation: During this stage, the data scientists at 3D solutions will collect data from over 300,000 Kickstarter projects and begin construction on a model that will be able to predict which Kickstarter projects will be the most successful and yield the best investment opportunities for AIU.
  
  3. Training Model: Next, the 3D Solutions data scientists will begin training the model and make any necessary changes to ensure that the model will produce the desired outputs for AIU. 
...
Since AIU wants a 20% increase in their investment portfolio of 10 million dollars, the return on investment to achieve that goal should be 2 million dollars in the span of a year. 
...
A few good investments through the implementation of this model will help AIU reach their success metric of 2 million dollars increase in their investment portfolio. 
